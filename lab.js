...
const myCat = new Cat('Chester', 1, 'Orange')
...
const myWizard = new Wizard('Gandolf', 200, 'Fireball')
myWizard.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
//Code Here
const phone1 = new Phone('Apple', 'iPhone 14', 128, 'Orange', 1000)
const phone2 = new Phone('Android', 'Galaxy S', 500, 'Black', 2000)
const phone3 = new Phone('Nokia', 'Nokia 1', 64, 'Red', 100)
/* 
...
//Code Here
const vehicle1 = new Vehicle(4, 'Black', 8000)
...
//Code Here 
const myFirstMotorcycle = new Motorcycle(1, 'Grey', 50000, 'IDK', true)
/*
...
//Code Here
const boat1 = new Boat(6, 'White', 2000, 'Sunny', 'Sailing Boat', false)
/*
